<template>
  <div>
    <nav class="navbar navbar-expand-lg">
      ...
      <a class="navbar-brand" href="#">Detexion</a>
      <button
  ...
  <!-- <nav>
  <!-- logo dari parent-->
  <!-- :src ini akan diisi dengan props yang didapat dari home  -->
  <!-- <a href=""> <img :src="logoHome" alt="" @click="home" ></a>
  <ul>Makan</ul>-->
  <!-- </nav>  -->
</template>
...
<script>
export default {
  props: ["logoHome", "isLogin"], // props menerima data dari parent
  methods: {
    home() {},
    logout() {
